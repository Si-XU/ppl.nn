...
#define LOAD_dBv1_SIZE1(_regB, _dBv1, _dBv1_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[0] * _INT4_TO_4INT_] : ZEROv1;\
            \
            _dBv1_off[0] += TILE_K_V4_PER_STEP; \
            \
            fltHWCv4Acc  += TILE_K_V4_PER_STEP; \
        }

#define LOAD_dBv1_SIZE2(_regB, _dBv1, _dBv1_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[0] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[1] = ( fltNValid[1] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[1] * _INT4_TO_4INT_] : ZEROv1;\
            \
            _dBv1_off[0] += TILE_K_V4_PER_STEP; \
...
#define LOAD_dBv1_SIZE4(_regB, _dBv1, _dBv1_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[0] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[1] = ( fltNValid[1] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[1] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[2] = ( fltNValid[2] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[2] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[3] = ( fltNValid[3] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[3] * _INT4_TO_4INT_] : ZEROv1;\
            \
            _dBv1_off[0] += TILE_K_V4_PER_STEP; \
            _dBv1_off[1] += TILE_K_V4_PER_STEP; \
...
#define LOAD_dBv1_SIZE8(_regB, _dBv1, _dBv1_off) \
        { \
            ...
            _regB[2] = ( fltNValid[2] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[2] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[3] = ( fltNValid[3] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[3] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[4] = ( fltNValid[4] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[4] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[5] = ( fltNValid[5] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[5] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[6] = ( fltNValid[6] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[6] * _INT4_TO_4INT_] : ZEROv1;\
            _regB[7] = ( fltNValid[7] && (fltHWCv4Acc < fltHWCv4) ) ? _dBv1[ _dBv1_off[7] * _INT4_TO_4INT_] : ZEROv1;\
            \
            _dBv1_off[0] += TILE_K_V4_PER_STEP; \
            _dBv1_off[1] += TILE_K_V4_PER_STEP; \
            _dBv1_off[2] += TILE_K_V4_PER_STEP; \
...
#define SET_dBv1_BOUND(_step_id, _dBv1_off, _fltNValid) \
        { \
            ...
            \
            _dBv1_off  =   grp_id   * fltHWCv4 * numFltPerGrpPad + \
                          _fltN_id  * fltHWCv4 + \
                           tid_x; \
        }
