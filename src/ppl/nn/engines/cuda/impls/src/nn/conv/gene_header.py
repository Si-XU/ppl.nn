...
def main():
    ...
    with open(tail_pwd + "/gene_header.cc", "w+") as f:
        ...
        init_include_file(f, sourse_pwd, "/int8_2spk/common/hmma_macros.h")
        ...
        init_include_file(f, sourse_pwd, "/int8_idxn/common/hmma_i1_macros.h")
        init_include_file(f, sourse_pwd, "/int8_idxn/common/dmem_i2_macros.h")
        init_include_file(f, sourse_pwd, "/int8_idxn/common/hmma_i2_macros.h")
        init_include_file(f, sourse_pwd, "/int8_idxn/common/dmem_i4_macros.h")
        init_include_file(f, sourse_pwd, "/int8_idxn/common/hmma_i4_macros.h")
