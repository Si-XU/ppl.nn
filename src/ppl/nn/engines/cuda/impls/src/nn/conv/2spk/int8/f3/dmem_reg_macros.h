...
#define LOAD_dAv4_SIZE_16TH(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 16 ))  \
                _regA[0] = ( (_fltHW_bid & inHWMask[0]) && _inCv16Valid ) ? _dA[ _dAv4_off[0] ] : ZEROv4;\
        }

#define LOAD_dAv4_SIZE_8TH(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 8 ))  \
...
#define LOAD_dAv4_SIZE_QTR(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 4 ))  \
...
#define LOAD_dAv4_SIZE_HALF(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 2 ))  \
...
#define LOAD_dAv4_SIZE1(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            \
            _regA[0] = ( (_fltHW_bid & inHWMask[0]) && _inCv16Valid ) ? _dA[ _dAv4_off[0] ] : ZEROv4;\
...
#define LOAD_dAv4_SIZE2(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            _dAv4_off[1] += cInLut.idx[cLut_id]; \
            \
            _regA[0] = ( (_fltHW_bid & inHWMask[0]) && _inCv16Valid ) ? _dA[ _dAv4_off[0] ] : ZEROv4;\
            _regA[1] = ( (_fltHW_bid & inHWMask[1]) && _inCv16Valid ) ? _dA[ _dAv4_off[1] ] : ZEROv4;\
        }

#define LOAD_dAv4_SIZE4(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            _dAv4_off[1] += cInLut.idx[cLut_id]; \
            ...
            _regA[0] = ( (_fltHW_bid & inHWMask[0]) && _inCv16Valid ) ? _dA[ _dAv4_off[0] ] : ZEROv4;\
            _regA[1] = ( (_fltHW_bid & inHWMask[1]) && _inCv16Valid ) ? _dA[ _dAv4_off[1] ] : ZEROv4;\
            _regA[2] = ( (_fltHW_bid & inHWMask[2]) && _inCv16Valid ) ? _dA[ _dAv4_off[2] ] : ZEROv4;\
            _regA[3] = ( (_fltHW_bid & inHWMask[3]) && _inCv16Valid ) ? _dA[ _dAv4_off[3] ] : ZEROv4;\
        }

#define LOAD_dAv4_SIZE8(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0] += cInLut.idx[cLut_id]; \
            _dAv4_off[1] += cInLut.idx[cLut_id]; \
            _dAv4_off[2] += cInLut.idx[cLut_id]; \
            ...
            _regA[2] = ( (_fltHW_bid & inHWMask[2]) && _inCv16Valid ) ? _dA[ _dAv4_off[2] ] : ZEROv4;\
            _regA[3] = ( (_fltHW_bid & inHWMask[3]) && _inCv16Valid ) ? _dA[ _dAv4_off[3] ] : ZEROv4;\
            _regA[4] = ( (_fltHW_bid & inHWMask[4]) && _inCv16Valid ) ? _dA[ _dAv4_off[4] ] : ZEROv4;\
            _regA[5] = ( (_fltHW_bid & inHWMask[5]) && _inCv16Valid ) ? _dA[ _dAv4_off[5] ] : ZEROv4;\
            _regA[6] = ( (_fltHW_bid & inHWMask[6]) && _inCv16Valid ) ? _dA[ _dAv4_off[6] ] : ZEROv4;\
            _regA[7] = ( (_fltHW_bid & inHWMask[7]) && _inCv16Valid ) ? _dA[ _dAv4_off[7] ] : ZEROv4;\
        }

#define LOAD_dAv4_SIZE16(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0]  += cInLut.idx[cLut_id]; \
            _dAv4_off[1]  += cInLut.idx[cLut_id]; \
            _dAv4_off[2]  += cInLut.idx[cLut_id]; \
            ...
            _regA[6]  = ( (_fltHW_bid & inHWMask[6])  && _inCv16Valid ) ? _dA[ _dAv4_off[6]  ] : ZEROv4;\
            _regA[7]  = ( (_fltHW_bid & inHWMask[7])  && _inCv16Valid ) ? _dA[ _dAv4_off[7]  ] : ZEROv4;\
            _regA[8]  = ( (_fltHW_bid & inHWMask[8])  && _inCv16Valid ) ? _dA[ _dAv4_off[8]  ] : ZEROv4;\
            _regA[9]  = ( (_fltHW_bid & inHWMask[9])  && _inCv16Valid ) ? _dA[ _dAv4_off[9]  ] : ZEROv4;\
            _regA[10] = ( (_fltHW_bid & inHWMask[10]) && _inCv16Valid ) ? _dA[ _dAv4_off[10] ] : ZEROv4;\
            _regA[11] = ( (_fltHW_bid & inHWMask[11]) && _inCv16Valid ) ? _dA[ _dAv4_off[11] ] : ZEROv4;\
            _regA[12] = ( (_fltHW_bid & inHWMask[12]) && _inCv16Valid ) ? _dA[ _dAv4_off[12] ] : ZEROv4;\
            _regA[13] = ( (_fltHW_bid & inHWMask[13]) && _inCv16Valid ) ? _dA[ _dAv4_off[13] ] : ZEROv4;\
            _regA[14] = ( (_fltHW_bid & inHWMask[14]) && _inCv16Valid ) ? _dA[ _dAv4_off[14] ] : ZEROv4;\
            _regA[15] = ( (_fltHW_bid & inHWMask[15]) && _inCv16Valid ) ? _dA[ _dAv4_off[15] ] : ZEROv4;\
        }

#define LOAD_dAv4_SIZE32(_regA, _dA, _dAv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dAv4_off[0]  += cInLut.idx[cLut_id]; \
            _dAv4_off[1]  += cInLut.idx[cLut_id]; \
            _dAv4_off[2]  += cInLut.idx[cLut_id]; \
            ...
            _regA[14] = ( (_fltHW_bid & inHWMask[14]) && _inCv16Valid ) ? _dA[ _dAv4_off[14] ] : ZEROv4;\
            _regA[15] = ( (_fltHW_bid & inHWMask[15]) && _inCv16Valid ) ? _dA[ _dAv4_off[15] ] : ZEROv4;\
            _regA[16] = ( (_fltHW_bid & inHWMask[16]) && _inCv16Valid ) ? _dA[ _dAv4_off[16] ] : ZEROv4;\
            _regA[17] = ( (_fltHW_bid & inHWMask[17]) && _inCv16Valid ) ? _dA[ _dAv4_off[17] ] : ZEROv4;\
            _regA[18] = ( (_fltHW_bid & inHWMask[18]) && _inCv16Valid ) ? _dA[ _dAv4_off[18] ] : ZEROv4;\
            _regA[19] = ( (_fltHW_bid & inHWMask[19]) && _inCv16Valid ) ? _dA[ _dAv4_off[19] ] : ZEROv4;\
            _regA[20] = ( (_fltHW_bid & inHWMask[20]) && _inCv16Valid ) ? _dA[ _dAv4_off[20] ] : ZEROv4;\
            _regA[21] = ( (_fltHW_bid & inHWMask[21]) && _inCv16Valid ) ? _dA[ _dAv4_off[21] ] : ZEROv4;\
            _regA[22] = ( (_fltHW_bid & inHWMask[22]) && _inCv16Valid ) ? _dA[ _dAv4_off[22] ] : ZEROv4;\
            _regA[23] = ( (_fltHW_bid & inHWMask[23]) && _inCv16Valid ) ? _dA[ _dAv4_off[23] ] : ZEROv4;\
            _regA[24] = ( (_fltHW_bid & inHWMask[24]) && _inCv16Valid ) ? _dA[ _dAv4_off[24] ] : ZEROv4;\
            _regA[25] = ( (_fltHW_bid & inHWMask[25]) && _inCv16Valid ) ? _dA[ _dAv4_off[25] ] : ZEROv4;\
            _regA[26] = ( (_fltHW_bid & inHWMask[26]) && _inCv16Valid ) ? _dA[ _dAv4_off[26] ] : ZEROv4;\
            _regA[27] = ( (_fltHW_bid & inHWMask[27]) && _inCv16Valid ) ? _dA[ _dAv4_off[27] ] : ZEROv4;\
            _regA[28] = ( (_fltHW_bid & inHWMask[28]) && _inCv16Valid ) ? _dA[ _dAv4_off[28] ] : ZEROv4;\
            _regA[29] = ( (_fltHW_bid & inHWMask[29]) && _inCv16Valid ) ? _dA[ _dAv4_off[29] ] : ZEROv4;\
            _regA[30] = ( (_fltHW_bid & inHWMask[30]) && _inCv16Valid ) ? _dA[ _dAv4_off[30] ] : ZEROv4;\
            _regA[31] = ( (_fltHW_bid & inHWMask[31]) && _inCv16Valid ) ? _dA[ _dAv4_off[31] ] : ZEROv4;\
        }
