...
#define LOAD_dBv4_SIZE1(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            \
            fltHWCv16Acc  += TILE_K_V16_PER_STEP; \
        }

#define LOAD_dBv4_SIZE2(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            _regB[1] = ( fltNValid[1] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[1] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
...
#define LOAD_dBv4_SIZE4(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( fltNValid[0] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            _regB[1] = ( fltNValid[1] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[1] ] : ZEROv4;\
            _regB[2] = ( fltNValid[2] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[2] ] : ZEROv4;\
            _regB[3] = ( fltNValid[3] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[3] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            _dBv4_off[1] += TILE_K_V16_PER_STEP; \
...
#define LOAD_dBv4_SIZE8(_regB, _dBv4, _dBv4_off) \
        { \
            ...
            _regB[2] = ( fltNValid[2] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[2] ] : ZEROv4;\
            _regB[3] = ( fltNValid[3] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[3] ] : ZEROv4;\
            _regB[4] = ( fltNValid[4] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[4] ] : ZEROv4;\
            _regB[5] = ( fltNValid[5] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[5] ] : ZEROv4;\
            _regB[6] = ( fltNValid[6] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[6] ] : ZEROv4;\
            _regB[7] = ( fltNValid[7] && (fltHWCv16Acc < fltHWCv16) ) ? _dBv4[ _dBv4_off[7] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            _dBv4_off[1] += TILE_K_V16_PER_STEP; \
            _dBv4_off[2] += TILE_K_V16_PER_STEP; \
...
#define SET_dBv4_BOUND(_step_id, _dBv4_off, _fltNValid) \
        { \
            ...
            \
            _dBv4_off  =   grp_id   * fltHWCv16 * numFltPerGrpPad + \
                          _fltN_id  * fltHWCv16 + \
                           tid_x; \
        }
