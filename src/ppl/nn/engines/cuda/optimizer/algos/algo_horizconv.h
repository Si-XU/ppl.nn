...
#ifndef _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_ALGOS_ALGO_HORIZCONV_H_
#define _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_ALGOS_ALGO_HORIZCONV_H_
...
class HorizConvAlgorithm : public Algorithm {
public:
    HorizConvAlgorithm() {
...
class HorizTuringHMMAImpgemm final : public HorizConvAlgorithm {
public:
...
private:
    CudaHorizConvParam attr_param_;
    std::map<nodeid_t, SelectionInfo> selection_res_;
};

class HorizTuringIMMAImpgemm final : public HorizConvAlgorithm {
public:
    int MAX_INT8 = 127;
    void GetAttrParam(void*& param) const override;
    void DeleteAttrParam(void*& param) override;
