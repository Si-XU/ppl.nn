...
class KernelInfo:
    def __init__(self, path, s_size, k_num, cta_y_num, cta_x_num, warp_y, warp_x):
        ...
        self.kname = "nvIdxnSM75Conv_hmma1688_nhwc" + self.kconfig
        self.fname = "sm75_fp16_kernels" + "/idxn"  + self.kconfig + ".cu"
    ...
    def GenKernel(self):
        ...
        if self.s_size == 8:
            ...
            f.write("#include \"idxn/common/hmma1688_i1_macros.h\"\n\n")
            ...
            f.write("#include \"idxn/common/hmma1688_i2_macros.h\"\n\n")
            ...
            f.write("#include \"idxn/common/hmma1688_i4_macros.h\"\n\n")
...
class IdxSourceFile:
    def __init__(self, path):
        self.path = path
        self.fname = "idxn_sm75_fp16_kernels.cu"

        self.f = open(os.path.join(self.path, self.fname), "w")

        self.f.write("#include  \"idxn/idxn_sm75_fp16_kernels.h\"\n\n")
...
class IdxHeaderFile:
    def __init__(self, path):
        self.path = path
        self.fname = "idxn_sm75_fp16_kernels.h"
...
class InitFile:
    def __init__(self, path):
        self.path = path
        self.fname = "init_idxn_sm75_fp16_kernels.cu"
...
def GenAllKernels(parent_path):
    ...
    path = parent_path + '/sm75_fp16_kernels'
