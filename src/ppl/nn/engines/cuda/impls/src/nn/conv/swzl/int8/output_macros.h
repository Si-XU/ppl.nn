...
#define DEQUANT_V4(fR, _R, _de_scale) \
        { \
            ...
            for(int i = 0; i < OUTPUT_BLKS_PER_STEP; i++) \
            { \
        	    fR[i * _INT4_TO_4INT_ + 0] = _R[i * _INT4_TO_4INT_ + 0] * _de_scale[0]; \
        	    fR[i * _INT4_TO_4INT_ + 1] = _R[i * _INT4_TO_4INT_ + 1] * _de_scale[1]; \
        	    fR[i * _INT4_TO_4INT_ + 2] = _R[i * _INT4_TO_4INT_ + 2] * _de_scale[2]; \
        	    fR[i * _INT4_TO_4INT_ + 3] = _R[i * _INT4_TO_4INT_ + 3] * _de_scale[3]; \
            } \
        }
...
#define QUANT_V4(_R, fR, _quant_scale) \
        { \
            ...
            for(int i = 0; i < OUTPUT_BLKS_PER_STEP; i++) \
            { \
                _R[i * _INT4_TO_4INT_ + 0] = __float2int_rn(fR[i * _INT4_TO_4INT_ + 0] * _quant_scale); \
                _R[i * _INT4_TO_4INT_ + 1] = __float2int_rn(fR[i * _INT4_TO_4INT_ + 1] * _quant_scale); \
                _R[i * _INT4_TO_4INT_ + 2] = __float2int_rn(fR[i * _INT4_TO_4INT_ + 2] * _quant_scale); \
                _R[i * _INT4_TO_4INT_ + 3] = __float2int_rn(fR[i * _INT4_TO_4INT_ + 3] * _quant_scale); \
            } \
        }
