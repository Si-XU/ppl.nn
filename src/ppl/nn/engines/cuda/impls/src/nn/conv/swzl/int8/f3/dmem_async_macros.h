...
#define LOAD_dBv4_SIZE_16TH(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 16 ))  \
                CP_ASYNC( ((_fltHW_bid & inHWMask[0]) && _inCv16Valid), _sBv4, _sBv4_off, _dB, _dBv4_off[0]); \
        }

#define LOAD_dBv4_SIZE_8TH(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 8 ))  \
...
#define LOAD_dBv4_SIZE_QTR(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 4 ))  \
...
#define LOAD_dBv4_SIZE_HALF(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 2 ))  \
...
#define LOAD_dBv4_SIZE1(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            \
            CP_ASYNC( ((_fltHW_bid & inHWMask[0]) && _inCv16Valid), _sBv4, _sBv4_off, _dB, _dBv4_off[0]); \
...
#define LOAD_dBv4_SIZE2(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            _dBv4_off[1] += cInLut.idx[cLut_id]; \
            \
            CP_ASYNC( ((_fltHW_bid & inHWMask[0]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 0, _dB, _dBv4_off[0]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[1]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 1, _dB, _dBv4_off[1]); \
        }

#define LOAD_dBv4_SIZE4(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            _dBv4_off[1] += cInLut.idx[cLut_id]; \
            ...
            CP_ASYNC( ((_fltHW_bid & inHWMask[0]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 0, _dB, _dBv4_off[0]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[1]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 1, _dB, _dBv4_off[1]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[2]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 2, _dB, _dBv4_off[2]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[3]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 3, _dB, _dBv4_off[3]); \
        }

#define LOAD_dBv4_SIZE8(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0] += cInLut.idx[cLut_id]; \
            _dBv4_off[1] += cInLut.idx[cLut_id]; \
            _dBv4_off[2] += cInLut.idx[cLut_id]; \
            ...
            CP_ASYNC( ((_fltHW_bid & inHWMask[2]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 2, _dB, _dBv4_off[2]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[3]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 3, _dB, _dBv4_off[3]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[4]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 4, _dB, _dBv4_off[4]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[5]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 5, _dB, _dBv4_off[5]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[6]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 6, _dB, _dBv4_off[6]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[7]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 7, _dB, _dBv4_off[7]); \
        }

#define LOAD_dBv4_SIZE16(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0]  += cInLut.idx[cLut_id]; \
            _dBv4_off[1]  += cInLut.idx[cLut_id]; \
            _dBv4_off[2]  += cInLut.idx[cLut_id]; \
            ...
            CP_ASYNC( ((_fltHW_bid & inHWMask[6])  && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 6,  _dB, _dBv4_off[6]);  \
            CP_ASYNC( ((_fltHW_bid & inHWMask[7])  && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 7,  _dB, _dBv4_off[7]);  \
            CP_ASYNC( ((_fltHW_bid & inHWMask[8])  && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 8,  _dB, _dBv4_off[8]);  \
            CP_ASYNC( ((_fltHW_bid & inHWMask[9])  && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 9,  _dB, _dBv4_off[9]);  \
            CP_ASYNC( ((_fltHW_bid & inHWMask[10]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 10, _dB, _dBv4_off[10]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[11]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 11, _dB, _dBv4_off[11]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[12]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 12, _dB, _dBv4_off[12]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[13]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 13, _dB, _dBv4_off[13]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[14]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 14, _dB, _dBv4_off[14]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[15]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 15, _dB, _dBv4_off[15]); \
        }

#define LOAD_dBv4_SIZE32(_sBv4, _sBv4_off, _dB, _dBv4_off, _inCv16Valid, _fltHW_bid) \
        { \
            _dBv4_off[0]  += cInLut.idx[cLut_id]; \
            _dBv4_off[1]  += cInLut.idx[cLut_id]; \
            _dBv4_off[2]  += cInLut.idx[cLut_id]; \
            ...
            CP_ASYNC( ((_fltHW_bid & inHWMask[14]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 14, _dB, _dBv4_off[14]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[15]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 15, _dB, _dBv4_off[15]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[16]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 16, _dB, _dBv4_off[16]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[17]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 17, _dB, _dBv4_off[17]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[18]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 18, _dB, _dBv4_off[18]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[19]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 19, _dB, _dBv4_off[19]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[20]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 20, _dB, _dBv4_off[20]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[21]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 21, _dB, _dBv4_off[21]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[22]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 22, _dB, _dBv4_off[22]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[23]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 23, _dB, _dBv4_off[23]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[24]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 24, _dB, _dBv4_off[24]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[25]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 25, _dB, _dBv4_off[25]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[26]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 26, _dB, _dBv4_off[26]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[27]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 27, _dB, _dBv4_off[27]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[28]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 28, _dB, _dBv4_off[28]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[29]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 29, _dB, _dBv4_off[29]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[30]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 30, _dB, _dBv4_off[30]); \
            CP_ASYNC( ((_fltHW_bid & inHWMask[31]) && _inCv16Valid), _sBv4, _sBv4_off + CTA_SIZE_IN_THD * 31, _dB, _dBv4_off[31]); \
        }
